...
Вы уже умеете изменять модель данных и проводить миграцию данных. 
Вы также привели информацию о заказах в интернет-магазине к удобной для аналитики форме.
Теперь необходимо пойти дальше — сделать миграцию в отдельные логические таблицы, а затем собрать на них витрину данных. 
...
Заказ в интернет-магазине — это набор купленных товаров и их количество. 
Покупатели привыкли получать заказы одномоментно, поэтому каждый заказ из набора товаров формируется в одну сущность доставки.
